									...
									'<ul>' +
										'<li class="icon icon-arrow-left">' +
											...
											'<div class="mp-level">' +
												...
												'<ul>' +
													'<li class="icon icon-arrow-left">' +
														'<a class="icon icon-female" href="#">Womens Clothing</a>' +
														'<div class="mp-level">' +
															'<h2 class="icon icon-female">Womens Clothing</h2>' +
															'<a class="mp-back" href="#">back</a>' +
															'<ul>' +
																'<li><a href="#">Tops</a></li>' +
													...
													'</li>' +
													'<li class="icon icon-arrow-left">' +
														'<a class="icon icon-male" href="#">Mens Clothing</a>' +
														'<div class="mp-level">' +
															'<h2 class="icon icon-male">Mens Clothing</h2>' +
															'<a class="mp-back" href="#">back</a>' +
															'<ul>' +
				...
				'<div class="scroller"><!-- this is for emulating position fixed of the nav -->' +
						'<!-- Top Navigation -->' +
							'<div class="block block-40 clearfix">' +
								'<p><a href="#" id="trigger" class="menu-trigger"><br /></a></p>' +
							'</div>	' +
				'</div><!-- /scroller -->' +
			'</div><!-- /pusher -->' +
		'</div><!-- /container -->'].join(),
